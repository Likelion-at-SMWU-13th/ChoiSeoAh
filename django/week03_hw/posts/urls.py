...
from .views import post_list_view, post_update_view, post_detail_view,post_form_view,post_create_form_view,create_comment_view
app_name='posts'
...
urlpatterns = [
    ...
    path('<int:id>/comment/',create_comment_view, name = 'create-comment'),
]